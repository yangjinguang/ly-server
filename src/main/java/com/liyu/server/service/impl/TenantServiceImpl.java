...
public class TenantServiceImpl implements TenantService {
    ...
    //    @Override
//    public void bindContact(String tenantId, String accountId) {
...
//
    ...
    public List<Tenant> byAccountId(String accountId) {
        return context.select(TENANT.fields())
                .from(CONTACT)
                .leftJoin(TENANT)
                .on(TENANT.TENANT_ID.eq(CONTACT.TENANT_ID))
                .where(CONTACT.ACCOUNT_ID.eq(accountId))
                .fetch()
                .into(Tenant.class);
    }
